/** Datos de contacto del cliente (única fuente para footer y enlaces). */
const contact = {
    address: "Capital Federal",
    email: "tuservicio.comercial@hotmail.com",
    /** Etiquetado según lo indicado por el cliente */
    phoneLandlineDisplay: "+54 9 11 4520-4427",
    phoneMobileDisplay: "+54 9 11 7834-3232",
    phoneLandlineTel: "+5491145204427",
    phoneMobileTel: "+5491178343232",
} as const;
...
/** Certificaciones y normativas (textos editables; íconos en SVG inline). */
const certifications = [
    {
        title: "Gestión de calidad",
        description:
            "Procesos alineados a buenas prácticas para asegurar servicios consistentes y mejora continua.",
    ...
    },
    {
        ...
        description:
            "Compromiso con la seguridad de nuestro personal y de quienes habitan los espacios que trabajamos.",
